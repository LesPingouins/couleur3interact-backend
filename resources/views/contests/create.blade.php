                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('polls.index') }}">Concours</a></li>
                        ...
                        <div class="col-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Créer un concours</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="{{ route('contests.store') }}">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group col-6">
                                                ...
                                                <input class="form-control" name="name_of" id="name_of" placeholder="Entrez un nom...">
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <input class="form-control" name="description" id="description" placeholder="Entrez une description..." />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-12">
                                                <label for="question">Question*</label>
                                                <input class="form-control" name="question" id="question" placeholder="Entrez une question..." />
                                        ...
                                        <div class="row">
                                            <div class="form-group col-12">
                                                <label for="duration">Durée du concours (en secondes)*</label>
                                                <input class="form-control" name="duration" id="duration" placeholder="Entrez une durée (en secondes)...">
                                        ...
                                        <div class="row pl-2">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="is_predefined" id="switch">
                                        ...
                                        <div id="divPredefined" class="mt-3">
                                            <div class="row">
                                                <div class="form-group col-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <input class="form-control" id="addChoice" placeholder="Ajoutez un choix..." />
                                                        </div>
                                                        <div class="col-4">
                                                            <button class="btn btn-primary" id="btnAddChoice"><i class="fa-solid fa-plus align-middle"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <template id="templateChoice">
                                                <div id="containerChoice" class="row col-6">
                                                    <div class="col-10 mt-1">
                                                        <input class="form-control " name="choices[]" id="choice" value="" />
                                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary">Envoyer le concours</button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card -->
